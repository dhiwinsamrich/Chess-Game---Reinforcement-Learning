...
from keras.models import Sequential      # type: ignore # One layer after the other
from keras.layers import Dense, Flatten  # type: ignore # Dense layers are fully connected layers, Flatten layers flatten out multidimensional inputs
import argparse
import os
import signal
import sys
